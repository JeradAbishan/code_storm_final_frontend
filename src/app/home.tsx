  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <Container size="4" className="py-8">
        {/* Hero Section */}
        <Section>
          <Flex direction="column" gap="6" align="center" className="text-center py-12">
            <Badge color="blue" variant="soft" size="2">
              AI-Powered Learning Platform
            </Badge>
            <Heading size="9" weight="bold" className="max-w-4xl">
              Transform Your Notes into{' '}
              <span className="text-blue-600 dark:text-blue-400">Powerful Learning Tools</span>
            </Heading>
            <Text size="5" className="max-w-2xl text-gray-600 dark:text-gray-400">
              Upload your handwritten or digital notes and let our AI enhance them with 
              summaries, questions, flashcards, and personalized study guides.
            </Text>
          ...
          <Flex direction="column" gap="8" align="center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
              <Card className="text-center">
                ...
                <CardContent>
                  <CardDescription>
                    ...
                    study guides, and interactive content to boost your learning.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                ...
                <CardContent>
                  <CardDescription>
                    Automatically organize your notes by subject, topic, and date. 
                    Search through everything with powerful AI-driven search.
                  </CardDescription>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <Text weight="bold" className="block">Google OAuth Integration</Text>
                    <Text size="2" className="text-gray-600 dark:text-gray-400">
                      Sign in securely with your Google account or create a new account
                    </Text>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-600 mt-1" />
                  <div>
                    <Text weight="bold" className="block">Advanced Security</Text>
                    <Text size="2" className="text-gray-600 dark:text-gray-400">
                      Multi-session support, secure authentication, and data protection
                    </Text>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-600 mt-1" />
                  <div>
                    <Text weight="bold" className="block">Email Verification</Text>
                    <Text size="2" className="text-gray-600 dark:text-gray-400">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <Text weight="bold" className="block">Privacy First</Text>
                    <Text size="2" className="text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <Text weight="bold" className="block">Lightning Fast</Text>
                    <Text size="2" className="text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <Text weight="bold" className="block">Collaborative Learning</Text>
                    <Text size="2" className="text-gray-600 dark:text-gray-400">
                      Share notes and study together with classmates (coming soon)
                    </Text>
                  </div>
                </div>
              </div>
            ...
            <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white border-none">
              <CardContent className="p-8 text-center">
                ...
                <Text size="4" className="mb-6 text-blue-100">
                  Join thousands of students already enhancing their notes with AI
                </Text>
        ...
        <Section className="py-8 border-t">
          <Flex justify="between" align="center">
            <Flex align="center" gap="2">
              ...
              <Text size="2" weight="bold">EduCapture</Text>
            </Flex>
